...
class AIService:
  ...
  def generate_presentation_structure(self, user_prompt: str) -> dict:
    ...
    try:
      ...
      Return ONLY a valid JSON object with this structure (and absolutely nothing else):
      {
      ...
      4. **Slide Types Examples**:
        ...
        TITLE SLIDE:
        <div class='h-full bg-gradient-to-br from-blue-900 via-blue-700 to-cyan-500 flex flex-col items-center justify-center text-white relative overflow-hidden'>
          <div class='absolute inset-0 bg-black bg-opacity-20'></div>
          <div class='relative z-10 text-center space-y-8'>
            <h1 class='text-7xl font-extrabold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-white to-cyan-200'>TITLE HERE</h1>
            <div class='w-32 h-1 bg-gradient-to-r from-cyan-400 to-white mx-auto mb-6'></div>
            <p class='text-2xl font-light text-cyan-100 max-w-2xl mx-auto leading-relaxed'>Subtitle description here</p>
          </div>
          <div class='absolute bottom-0 left-0 w-full h-32 bg-gradient-to-t from-black to-transparent opacity-30'></div>
        </div>
    
        CONTENT SLIDE:
        <div class='h-full bg-gradient-to-br from-purple-900 via-violet-700 to-indigo-500 p-12 flex flex-col'>
          <div class='text-center mb-12'>
            <h2 class='text-5xl font-bold text-white mb-4'>Slide Title</h2>
            <div class='w-24 h-1 bg-gradient-to-r from-violet-400 to-purple-300 mx-auto'></div>
          </div>
          <div class='flex-1 grid grid-cols-2 gap-12 items-center'>
            <div class='space-y-6'>
              <div class='bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-8 border border-white border-opacity-20'>
                <h3 class='text-3xl font-semibold text-white mb-6'>Key Points</h3>
                <ul class='space-y-4 text-xl text-white'>
                  <li class='flex items-center'>
                    <div class='w-3 h-3 bg-gradient-to-r from-violet-400 to-purple-300 rounded-full mr-4 flex-shrink-0'></div>
            ...
            <div class='bg-white bg-opacity-10 backdrop-blur-sm rounded-2xl p-8 border border-white border-opacity-20 flex items-center justify-center'>
              <p class='text-white text-xl font-light'>Chart/Visual Placeholder</p>
            </div>
          </div>
        </div>
    
        EMPHASIS SLIDE:
        <div class='h-full bg-gradient-to-br from-orange-900 via-red-600 to-pink-500 flex items-center justify-center text-white relative overflow-hidden'>
          <div class='absolute inset-0'>
            <div class='absolute top-10 left-10 w-64 h-64 bg-white bg-opacity-5 rounded-full'></div>
            <div class='absolute bottom-10 right-10 w-96 h-96 bg-white bg-opacity-5 rounded-full'></div>
          </div>
          <div class='relative z-10 text-center max-w-4xl mx-auto px-8'>
            <h2 class='text-6xl font-bold mb-8 leading-tight'>Key Message Here</h2>
            <div class='w-32 h-1 bg-gradient-to-r from-orange-300 to-pink-300 mx-auto mb-8'></div>
            <p class='text-2xl font-light text-orange-100 leading-relaxed'>Supporting explanation or quote that emphasizes the main point beautifully</p>
          </div>
        </div>
